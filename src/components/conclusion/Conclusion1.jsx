...
const Conclusion1 = () => {
  ...
  return (
    ...
    >
      <div
        className='absolute z-10 top-2 left-[50.75%] 3xl:left-[51.2%] transform -translate-x-1/2'
        ref={leftSideRef}
      >
      ...
      <div
        className='w-full h-full flex items-center justify-center px-4 animated-text'
        ref={leftSideRef}
      >
